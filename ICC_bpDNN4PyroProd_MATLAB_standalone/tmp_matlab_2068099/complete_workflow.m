try
    ...
    diaryFile = fullfile('/projects/illinois/eng/cee/siqi/MATLAB_Jobs_new4bpDNN/ICC_bpDNN4PyroProd_MATLAB_standalone/output/full_analysis', 'matlab_log_2068099.txt');
    diary(diaryFile);
    fprintf('===== COMPLETE WORKFLOW STARTED =====\n');
    fprintf('Job ID: 2068099\n');
