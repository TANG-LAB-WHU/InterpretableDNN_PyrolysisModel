...
% Setup target names with product descriptions
if isfield(results, 'targetNames')
    targetNames = results.targetNames;
else
    % Create default target names with product descriptions
    ...
    disp('Using default target names with product descriptions (no targetNames found in SHAP results)');
end
