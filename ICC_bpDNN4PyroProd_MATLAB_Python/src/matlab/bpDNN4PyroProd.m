clc;
% clear all % clean workspace for new job
...
% Transfer functions precompiled in MATLAB are engaged for 
% training neural networks in the following list:
...
% Save training results to project root directory and current directory
fprintf('Saving training results to Results_trained.mat...\n');
...
% Save results
save("Results_trained.mat");  % Save to current directory
fprintf('Saving results to output directory...\n');
copyfile('Results_trained.mat', 'output/results/Results_trained.mat');

% If Figures directory exists, also copy to results
...
% Create zip backup
fprintf('Creating backup zip file...\n');
zip('output/results/Result_needed.zip', {'Results_trained.mat','Figures', 'bpDNN4PyroProd.m'});
% rmdir Figures s
