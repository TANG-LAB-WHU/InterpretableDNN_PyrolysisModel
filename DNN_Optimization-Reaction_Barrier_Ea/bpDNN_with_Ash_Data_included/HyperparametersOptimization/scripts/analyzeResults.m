...
print(gcf, fullfile(output_dir, 'time_vs_val_mse.png'), '-dpng', '-r600');
print(gcf, fullfile(output_dir, 'time_vs_val_mse.eps'), '-depsc2', '-r600');
...
print(gcf, fullfile(output_dir, 'r2_comparison.png'), '-dpng', '-r600');
print(gcf, fullfile(output_dir, 'r2_comparison.eps'), '-depsc2', '-r600');
...
print(gcf, fullfile(output_dir, 'top10_performance.png'), '-dpng', '-r600');
print(gcf, fullfile(output_dir, 'top10_performance.eps'), '-depsc2', '-r600');
end
