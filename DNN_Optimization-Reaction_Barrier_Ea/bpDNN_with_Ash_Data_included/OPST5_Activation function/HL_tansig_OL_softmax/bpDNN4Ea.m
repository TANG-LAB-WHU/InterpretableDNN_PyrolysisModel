...
for i = 1 : Nl
    if i == Nl
        net.layer{i}.transferFcn = 'softmax'; % the transfer function from the last hidden layer to the output layer, available ones including 'purelin', 'logsig', and 'softmax'
    else
        net.layer{i}.transferFcn = 'tansig'; % the transfer function in hidden layers, available ones including 'tansig', 'logsig', and 'tansigopt' (unavailable)
    end
end
