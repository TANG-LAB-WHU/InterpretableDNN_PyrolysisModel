...
for i = 1 : Nl
    if i == Nl
        net.layer{i}.transferFcn = 'logsig'; % the transfer function from the last hidden layer to the output layer, available ones including 'purelin', 'logsig', and 'softmax'
    else
