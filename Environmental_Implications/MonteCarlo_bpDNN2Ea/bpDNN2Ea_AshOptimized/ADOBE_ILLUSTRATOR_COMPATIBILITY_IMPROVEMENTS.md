# Adobe Illustrator Compatibility Improvements for SHAP Analysis

## Overview
This document describes the improvements made to `shap_analysis_ea.py` to ensure better compatibility with Adobe Illustrator for editing exported vector graphics.
...
The script will automatically generate all three formats for each visualization. 