...
function visualize_results(results_dir, figures_dir)
    ...
    saveas(gcf, fullfile(figures_dir, 'MSE_Comparison.png'));
    ...
    saveas(gcf, fullfile(figures_dir, 'R2_Comparison.png'));
    ...
    saveas(gcf, fullfile(figures_dir, 'Training_Time.png'));
    ...
    saveas(gcf, fullfile(figures_dir, 'LR_vs_MSE.png'));
    ...
    saveas(gcf, fullfile(figures_dir, 'Momentum_vs_MSE.png'));
